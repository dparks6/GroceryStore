  ...
  return (
    <form className="bg-white outline p-5 w-[30rem] h-full flex flex-col rounded-xl">
      ...
      <div className=" flex flex-col items-center">
        ...
        <div className="ml-2">
          <input
            className="outline p-2 rounded-xl w-[12rem] mb-6 mr-3"
        ...
        <div className="mr-12">
          <input
            className="outline p-2 rounded-xl w-[12rem] mb-5 ml-10"
        ...
        <div>
          <button className="rounded-3xl font-bold bg-emerald-400 w-32 p-2">
            Pay
          </button>
        </div>
      </div>
